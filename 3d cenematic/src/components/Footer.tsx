...
export default function Footer() {
    return (
        <footer className={styles.footer}>
            {/* Left: Brand / Mission (Restored and filled per user request) */}
            <div className={styles.leftCol}>
                <h2 className={styles.name}>VISHNU VARDHAN</h2>
                <span className={styles.mission}>CODING THE FUTURE OF AI</span>
                <div className={styles.copyright}>
                    © {new Date().getFullYear()} All Rights Reserved.
                </div>
            </div>

            {/* Right: Contact & Links (Converted to Icons) */}
            <div className={styles.rightCol}>
                <Link href="#" className={styles.iconLink} aria-label="LinkedIn">
                ...
                <Link href="#" className={styles.iconLink} aria-label="GitHub">
                ...
                <Link href="mailto:vishnuvardhanthe8055@gmail.com" className={styles.iconLink} aria-label="Email">
